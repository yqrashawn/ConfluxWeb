...
var tests = [
    {
        ...
        // signature from cfx_signTransaction
    ...
    describe("accounts", function () {
        ...
        tests.forEach(function (test, i) {
            if (test.error) {
                ...
                it("signTransaction must compare to cfx_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
                ...
                it("signTransaction using the iban as \"to\" must compare to cfx_signTransaction", function(done) {
                    var ethAccounts = new Accounts();
